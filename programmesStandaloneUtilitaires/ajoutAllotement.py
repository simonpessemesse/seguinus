...
#ajouteAllotementTousLesJours(date(2016,4,1),date(2016,7,10),inn) #rajoute des allotements 
#ajouteAllotementTousLesJours(date(2016,9,1),date(2016,11,1),inn) #rajoute des allotements 
