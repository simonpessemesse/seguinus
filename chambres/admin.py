...
class ClientInline(admin.StackedInline):
    ...
    fieldsets = (
        (None, {
            'fields': (('dateArrivee', 'dateDepart'), ('chambres', 'chambresSingle', 'chambresDoubles', 'chambresTwin'),
                       ('placesDortoir', 'chambresTriples', 'chambresQuadruples', 'chambresQuintuples'),
                       ('chambresAssignees', 'nbEnfants'))
        }),
    )
...
class TacheAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('Options Avancees', {
            'classes': ('collapse',),
            'fields': ('chaqueLundi', 'chaqueMardi', 'chaqueMercredi', 'chaqueJeudi', 'chaqueVendredi', 'chaqueSamedi',
                       'chaqueDimanche', 'expiration')
        }),
    )
