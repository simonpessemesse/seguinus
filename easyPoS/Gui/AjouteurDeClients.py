...
class Ajouteur(QtGui.QMainWindow):
	...
	def nouvo(self):
		...
		client.save()
		resa=Reservation(client=client,dateArrivee=arrivee,dateDepart=depart,chambresSingle=sin,chambresDoubles=double,chambresTwin=twin,chambresTriples=triple,chambresQuadruples=quadruple,chambresQuintuples=quintuple,placesDortoir=dortoir)
		resa.save()
