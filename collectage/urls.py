...
urlpatterns = [
    ...
    url(r'^emploiDuTemps/(?P<annee>\d+)/(?P<mois>\d+)/(?P<jour>\d+)/(?P<anneeF>\d+)/(?P<moisF>\d+)/(?P<jourF>\d+)/$',
        views.intervalle),
    url(
        r'^emploiDuTemps/(?P<annee>\d+)/(?P<mois>\d+)/(?P<jour>\d+)/(?P<anneeF>\d+)/(?P<moisF>\d+)/(?P<jourF>\d+)/(?P<contrat>\d+)/$',
        views.intervalleEmploye),
    url(
        r'^emploiDuTemps/(?P<annee>\d+)/(?P<mois>\d+)/(?P<jour>\d+)/(?P<anneeF>\d+)/(?P<moisF>\d+)/(?P<jourF>\d+)/(?P<contrat>\d+)/print$',
        views.intervalleEmployePrint),
    url(
        r'^emploiDuTemps/(?P<annee>\d+)/(?P<mois>\d+)/(?P<jour>\d+)/(?P<anneeF>\d+)/(?P<moisF>\d+)/(?P<jourF>\d+)/(?P<contrat>\d+)/copier$',
        views.copierIntervalleEmploye),
    url(
        r'^emploiDuTemps/(?P<annee>\d+)/(?P<mois>\d+)/(?P<jour>\d+)/(?P<anneeF>\d+)/(?P<moisF>\d+)/(?P<jourF>\d+)/(?P<contrat>\d+)/preremplir$',
        views.preremplir),
    url(
        r'^emploiDuTemps/(?P<annee>\d+)/(?P<mois>\d+)/(?P<jour>\d+)/(?P<anneeF>\d+)/(?P<moisF>\d+)/(?P<jourF>\d+)/(?P<contrat>\d+)/reset$',
        views.reset)
]
