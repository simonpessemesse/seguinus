...
#				t.save()
	...
	return render_to_response('taches/'+temp, {'year': annee,'month':mois,'entites':entites,	'day':jour,'next':next,'prev':prev,'date':dateDemandee,'taches':tToday,'prochainsJours':prochainsJours,'dateDemandee':dateDemandee,'cat':cat})
